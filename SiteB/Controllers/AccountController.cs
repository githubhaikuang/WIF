...
namespace SiteB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            //SingleSignOnManager.SignOut().Distinct().ToArray();
            return RedirectToAction("Index", "Home");
        }
    ...
    public class SingleSignOnManager
    {
        ...
        public static string[] SignOut()
        {
            ...
            HttpCookie FedAuth = HttpContext.Current.Request.Cookies[SITECOOKIENAME];
            if (FedAuth != null)
            {
                FedAuth.Expires = DateTime.Now.AddYears(-1);
                HttpContext.Current.Response.AppendCookie(FedAuth);
            }

            HttpCookie FedAuth1 = HttpContext.Current.Request.Cookies[SITENAME];
            if (FedAuth1 != null)
            {
                FedAuth1.Expires = DateTime.Now.AddYears(-1);
                HttpContext.Current.Response.AppendCookie(FedAuth1);
            }
